...
public class TaskCompleterOfInt {
	...
	private volatile IntPredicate successComplete;
	 ...
	 */
	public boolean signalSuccess(int returnValue) {
		if(state.get() == UNSET) {
	...
	void setup(/*notnull*/IntPredicate success, /*notnull*/Predicate<Throwable> fail) {
