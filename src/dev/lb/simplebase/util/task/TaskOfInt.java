...
public interface TaskOfInt extends Task {
	 ...
	 */
	@Override public TaskOfInt await(@Out CancelCondition condition) throws InterruptedException, CancelledException, OutParamStateException;
	/**
	 ...
	 * @throws NullPointerException When {@code condition} is {@code null}
	 */
	@Override public TaskOfInt awaitUninterruptibly(@Out CancelCondition condition) throws CancelledException, OutParamStateException;
	/**
	 ...
	 */
	@Override public TaskOfInt await(long timeout, TimeUnit unit, @Out CancelCondition condition) throws InterruptedException, TimeoutException, CancelledException, OutParamStateException;
	/**
	 ...
	 * @throws NullPointerException When {@code unit} or {@code condition} is {@code null}
	 */
	@Override public TaskOfInt awaitUninterruptibly(long timeout, TimeUnit unit, @Out CancelCondition condition) throws TimeoutException, CancelledException, OutParamStateException;
	/**
