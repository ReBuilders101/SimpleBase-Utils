...
abstract class BlockingTaskOfBool implements TaskOfBool {
	...
	@Override
	public TaskOfBool await(CancelCondition condition) throws InterruptedException, CancelledException {
	...
	@Override
	public TaskOfBool awaitUninterruptibly(CancelCondition condition) throws CancelledException {
		//cannot use null as that is the master permit
		Objects.requireNonNull(condition, "'condition' parameter must not be null");
	...
	@Override
	public TaskOfBool await(long timeout, TimeUnit unit, CancelCondition condition) throws InterruptedException, TimeoutException, CancelledException {
		//cannot use null as that is the master permit
		Objects.requireNonNull(condition, "'condition' parameter must not be null");
		Objects.requireNonNull(unit, "'unit' parameter must not be null");
	...
	@Override
	public TaskOfBool awaitUninterruptibly(long timeout, TimeUnit unit, CancelCondition condition) throws TimeoutException, CancelledException {
		//cannot use null as that is the master permit
		Objects.requireNonNull(condition, "'condition' parameter must not be null");
		Objects.requireNonNull(unit, "'unit' parameter must not be null");
	...
	static class ConditionWaiterTaskOfBool extends BlockingTaskOfBool {
		...
		private boolean succeed(boolean value) {
