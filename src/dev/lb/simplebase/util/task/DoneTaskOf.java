 ...
 */
@Internal
abstract class DoneTaskOf<T> implements TaskOf<T> {
	...
	@Internal
	static class CancelledTaskOf<T> extends DoneTaskOf<T> {

		private final CancelledException exception;
		
		CancelledTaskOf(CancelledException exception) {
	...
	@Internal
	static class SuccessfulTaskOf<T> extends DoneTaskOf<T> {
		static final SuccessfulTaskOf<Void> INSTANCE = new SuccessfulTaskOf<>(null);
		
		private final T value;
		
		SuccessfulTaskOf(T value) {
			this.value = value;
		}
	...
	@Internal
	static class FailedTaskOf<T> extends DoneTaskOf<T> {

		private final Throwable exception;
		private final AtomicBoolean isConsumed;

		FailedTaskOf(Throwable exception) {
